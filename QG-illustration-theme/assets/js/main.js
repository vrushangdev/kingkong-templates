(function($) {
    ...
    $(document).ready(function () {
        ...
        // Add Default Icons
        $('.form-container input[type="text"], textarea, select').parent('div').append('<i class="color-brand-2 far fa-comment-dots"></i>');
        
        // Specific icons
        $('.form-container input[name*="name"], input[name*="Name"]').parent('div').append('<i class="color-brand-2 far fa-user-circle"></i>');

        $('.form-container input[type="email"], input[name*="email"], input[name*="Email"], input[type="email"]').parent('div').append('<i class="color-brand-2 far fa-envelope"></i>');

        $('.form-container input[type = "tel"], input[name*="phone"], input[name*="Phone"], input[name*="mobile"], input[name*="Mobile"], input[name*="landline"], input[name*="Landline"], input[type="tel"]').parent('div').append('<i class="color-brand-2 fas fa-mobile-alt"></i>');

        $('.form-container input[name*="location"], input[name*="Location"], input[name *= "place"], input[name *= "Place"], input[name *= "city"], input[name *= "City"], input[name *= "suburb"], input[name *= "Suburb"], input[name *= "address"], input[name *= "Address"], input[name *= "country"], input[name *= "Country"], input[name *= "state"], input[name *= "State"], input[name *= "provinance"], input[name *= "Provinance"]').parent('div').append('<i class="color-brand-2 fas fa-map-marker-alt"></i>');
